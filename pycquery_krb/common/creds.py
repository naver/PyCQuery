...
from pycquery_krb.common.constants import KerberosSecretType
from pycquery_krb.protocol.encryption import string_to_key, Enctype
from pycquery_krb.protocol.constants import EncryptionType, ETYPES_BY_NAME
from pycquery_krb.common.ccache import CCACHE
from pycquery_krb.common.keytab import Keytab
...
class KerberosCredential:
	...
	def etype_supported(etype):
		...
		etype_int = ETYPES_BY_NAME.get(etype)
		if etype_int is None:
			return 0
		elif etype_int in supported:
			return etype_int
		else:
			return 0
